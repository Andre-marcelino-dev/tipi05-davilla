    ...
    @php
        $features = asset(
            'davilla/IMG/sweetest-day-poster-frame-border-with-pastel-background-assorted-chocolate-truffles.jpg',
        );
    @endphp
    <section class="testimonial-section-two">
        ...
        <div class="auto-container">
            <div class="sec-title light text-center">
                <div class="divider"><img src="{{ asset('davilla/images/icons/divider_2_light.png') }}" alt="">
                </div>
            ...
            <div class="content-box">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel sem imperdiet, venenatis eros
                    ac, mattis mauris. Nam ac purus justo.</p>
            </div>
