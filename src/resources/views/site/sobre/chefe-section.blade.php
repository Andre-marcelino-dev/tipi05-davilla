<!-- Chef Section -->
    ...
    <section class="chef-section" style="background-image: url(http://html.cwsthemes.com/bellaria/images/background/38.jpg);">
        <div class="auto-container">
            <div class="row">
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <figure class="image"><img src="{{asset('davilla/IMG/chefe.png')}}" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
